...
const GAME_CONTRACT_ADDRESS = "0x6eAEb51FfA0Bb99C3Ae6502Bb678F560930b55ad";
...
if (!APECHAIN_RPC_URL || !APECHAIN_WSS_URL || !FUTBOL_PK) {
  console.error('Missing required environment variables. Expected APECHAIN_RPC_URL, APECHAIN_WSS_URL, and FUTBOL_PK.');
  process.exit(1);
}
...
const wallet = new ethers.Wallet(FUTBOL_PK, provider);
