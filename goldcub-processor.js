...
const GAME_CONTRACT_ADDRESS = "0xe9cd5837609C548453f73BD4d531FE86c5d1E635";
...
if (!APECHAIN_RPC_URL || !APECHAIN_WSS_URL || !GOLD_CUB_PK) {
  console.error('Missing required environment variables. Expected APECHAIN_RPC_URL, APECHAIN_WSS_URL, and GOLD_CUB_PK.');
  process.exit(1);
}
...
const wallet = new ethers.Wallet(GOLD_CUB_PK, provider);
