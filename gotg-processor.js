...
const GAME_CONTRACT_ADDRESS = "0x1AC78E6a153DeEd1b8dB67b9813991651D53E3a6";
...
if (!APECHAIN_RPC_URL || !APECHAIN_WSS_URL || !GOTG_KEY) {
  console.error('Missing required environment variables. Expected APECHAIN_RPC_URL, APECHAIN_WSS_URL, and GOTG_KEY.');
  process.exit(1);
}
...
const wallet = new ethers.Wallet(GOTG_KEY, provider);
